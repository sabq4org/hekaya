          ...
          <Card className="bg-white dark:bg-gray-800 dark:border-gray-700" style={{ border: '1px solid #f0f0ef', borderRadius: '12px', boxShadow: 'none' }}>
            <CardContent className="p-8 lg:p-12">
              <div className="prose prose-lg max-w-none">
                ...
                {/* Summary Box */}
                <div className="p-6 mb-8 bg-gray-50 dark:bg-gray-900 border-r-4 border-purple-600 rounded-lg">
              ...
              <div>
                ...
                <div className="mt-12 p-6 text-center" style={{ backgroundColor: '#f0f0ef', borderRadius: '12px' }}>
                  <p className="text-lg font-medium text-gray-800">
                    &ldquo;الذكاء الاصطناعي لن يحل محل الأطباء، ولكن الأطباء الذين يستخدمون الذكاء الاصطناعي سيحلون محل أولئك الذين لا يستخدمونه&rdquo;
                  </p>
